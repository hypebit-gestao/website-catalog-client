    ...
    >
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button
              className={`w-full md:w-[90%] xl:w-[100%] relative h-auto py-4 m-auto flex flex-row bg-green-primary  items-center z-10 ${
            ...
            >
              <Disclosure.Panel className="m-auto relative flex flex-col  bg-gray-200  z-0 -top-6 w-full md:w-[90%] xl:w-[100%] rounded-lg">
                <div
